...
namespace suplex {
    namespace widget {
        void ItemLabel(std::string const& title, ItemLabelFlag flag)
        {
            ...
            if (flag & ItemLabelFlag::Right) textRect.Min.x = textRect.Min.x + itemWidth;
        ...
        void Vec3Control(const std::string& label, glm::vec3& values, float resetValue, float columnWidth)
        {
            ...
            if (ImGui::Button(ICON_FA_X, buttonSize)) values.x = resetValue;
            ImGui::PopFont();
            ...
            ImGui::PushFont(boldFont);
            if (ImGui::Button(ICON_FA_Y, buttonSize)) values.y = resetValue;
            ImGui::PopFont();
            // ImGui::PopStyleColor(3);
            ...
            ImGui::PushFont(boldFont);
            if (ImGui::Button(ICON_FA_Z, buttonSize)) values.z = resetValue;
            ImGui::PopFont();
            // ImGui::PopStyleColor(3);
